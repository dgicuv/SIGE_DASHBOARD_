...
export function DataTable({
  ...
  return (
    <div className={`flex flex-col ${className}`}>
      ...
      <AlertDialog open={pendingFormat !== null} onOpenChange={(open) => { if (!open) setPendingFormat(null); }}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Exportar datos</AlertDialogTitle>
            <AlertDialogDescription>
              Se descargará <span className="font-medium text-foreground">{title}</span> como archivo <span className="font-medium text-foreground uppercase">{pendingFormat}</span>.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel>Cancelar</AlertDialogCancel>
            <AlertDialogAction onClick={() => { if (pendingFormat) exportData(pendingFormat); setPendingFormat(null); }}>
              Descargar
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
